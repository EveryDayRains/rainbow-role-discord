...
//const client = new SDC('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY1OTM4MTM0MDQ5NTU0NDMzMSIsImlhdCI6MTU3NzMxMzc4Nn0.ggx02pqVJ6qlH6sUEdnDbQZvOmt3ycD1LuZFAIGSM5I');
...
async function color () {
    forEachTimeout(colors, (color) => {
        bot.guilds.forEach((guild) => {
                ...
                let role = guild.roles.find(x => x.name === "Радуга")
...
bot.on('ready', () => {
    ...
    //.then(console.log);
    console.log(`[BOOT]Запустился бот ${bot.user.username}`);
